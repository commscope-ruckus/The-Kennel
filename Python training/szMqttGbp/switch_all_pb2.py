...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[switches_pb2.DESCRIPTOR,])
...
_SWITCHMESSAGE.fields_by_name['switchStatus'].message_type = switches_pb2._SWITCHSTATUS
_SWITCHMESSAGE.fields_by_name['switchStats'].message_type = switches_pb2._SWITCHSTATS
_SWITCHMESSAGE.fields_by_name['portStatuses'].message_type = switches_pb2._PORTSTATUS
_SWITCHMESSAGE.fields_by_name['portStats'].message_type = switches_pb2._PORTSTATS
_SWITCHMESSAGE.fields_by_name['connectedDevicesStatus'].message_type = switches_pb2._CONNECTEDDEVICESTATUS
_SWITCHMESSAGE.fields_by_name['switchUnitStatuses'].message_type = switches_pb2._SWITCHUNITSTATUS
_SWITCHMESSAGE.fields_by_name['switchClientVisibility'].message_type = switches_pb2._SWITCHCLIENTVISIBILITY
_SWITCHMESSAGE.fields_by_name['switchClientStatus'].message_type = switches_pb2._SWITCHCLIENTSTATUS
DESCRIPTOR.message_types_by_name['SwitchMessage'] = _SWITCHMESSAGE

SwitchMessage = _reflection.GeneratedProtocolMessageType('SwitchMessage', (_message.Message,), dict(
