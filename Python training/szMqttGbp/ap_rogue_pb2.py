...
_ROGUEAPSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='serialNumber', full_name='RogueAPStats.serialNumber', index=22,
...
ReportType = _reflection.GeneratedProtocolMessageType('ReportType', (_message.Message,), dict(
...
RogueAPStats = _reflection.GeneratedProtocolMessageType('RogueAPStats', (_message.Message,), dict(
